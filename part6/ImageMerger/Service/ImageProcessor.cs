...
namespace ImageMergerService
{
    public class ImageProcessor
    {
        ...
        private readonly string outputDirectoryQueue;
        private readonly Dictionary<string, Tuple<ImageToPdfFileMerger, int>> prefixToState;

        public ImageProcessor(string outputDirectory, string outputDirectoryQueue)
        {
        ...
        public void ProcessFile(string file, Tuple<string, int> fileDescription)
        {
            ...
            {
                var newMerger = new ImageToPdfFileMerger(outputDirectory, outputDirectoryQueue, prefix + fileSeqNumber.ToString() + ".pdf");
            ...
            if (lastSeqNumber != fileSeqNumber - 1)
            {
                ...
                merger = new ImageToPdfFileMerger(outputDirectory, outputDirectoryQueue, prefix + fileSeqNumber.ToString() + ".pdf");
            }
